  ...
  <div class="fluid container">
    <div class="form-group form-group-lg panel panel-default">
      ...
      <div class="panel-body">
		...
		<button type="button" class="btn btn-default" @click="addChaos">增加实验</button>
		<button type="button" class="btn btn-default">增加主机</button>
		<button type="button" class="btn btn-default">场景编排</button>
      </div>
    </div>
